...
class Handle_hash_map
  : private tsl::robin_map<Key,T,Hash,KeyEqual>
{
    typedef tsl::robin_map<Key,T,Hash,KeyEqual> Base;
...
public:
    ...
    {
        return const_cast<mapped_type&>(Base::try_emplace(key,_default).first->second);
    }
